<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
    	...
    	// 발급해서 쿠키로 사용자에게 내려보낸다. JSESSIONID의 값은 클라이언트를
    	// 구분하는 식별자 역할을 한다.
    	...
    	// 클라이언트에게 JSESSIONID를 내려보냈다고 해서 서버에 해당 사용자의 메모리 공간이
    	...
    	// 2. 또는 Jsp 기본 객체인 session 내장 객체를 호출 할 때도 세션 객체가 만들어지고
    	// 메모리에 해당 클라인트의 메모리 공간이 확보된다.
    	// 1.번, 2번을 하지 않으면 해당 클라이언트의 세션 객체는 null이다.
    	...
    	// 시간 변환
    	java.util.Date lastDate = new java.util.Date(lastAccessedTime);    
    %>
<!DOCTYPE html>
<html>
<head>
