...
%>
	<!-- useBean 액션 태그
		...
		3. member인 객체가 없으면 member 객체를 생성해서 제공해준다.
	 -->
	...
	<!-- jsp:setProperty 액션 태그
		...
		2. member 객체가 갖고 있는 setter 메소드에다 이전 화면에서 받은 파라미터를 
		   자동으로 포집해준다.
		3. Html 폼에서 전송된 값을 자동으로 자바빈 클래스의 속성에 바인딩해준다.
		4. 이전에 화면에서 name 속성에 있는 이름과 자바빈즈 도메인 클래스의 속성이름이
		   동일해야 가능하다.   
		5. property="*" : 전체 속성을 바인딩해준다.   
	 -->
